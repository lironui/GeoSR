...
def get_args():
    ...
    arg("-i", "--image_path", type=str, default=r'D:\lironui\dataset\UAVid\uavid_test', help="Path to  huge image")
    arg("-c", "--config_path", type=Path, default='./config/uavid/unetformer.py', help="Path to  config")
    arg("-o", "--output_path", type=Path, help="Path to save resulting masks.", default=r'D:\lironui\dataset\UAVid\result')
